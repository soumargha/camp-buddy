        ...
        <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex md:items-center md:justify-center md:gap-5">
                <button aria-current="page"
                    ...
                    href="#">Your Items</button>
                <button className="inline-block rounded-lg px-2 py-1 text-sm font-medium text-gray-900 transition-all duration-200 hover:bg-gray-200 hover:text-gray-900"
                    href="#">Cart</button>
            </div>
