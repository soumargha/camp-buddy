...
<div
    ...
    <div className="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
        <img className="object-cover object-center h-32" src='https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhfQkI3na3twQ1EbT1Q2YSD7Dsp2F_Obx5DUDDHDRAIB05VsperIyffiJkzFglbZl2V_AIzs2OhIoo9Tux9QmJJuqBKcrgRD_rAxSr_7BviTgP51FMtGKLZNxf7GgIMfZIvmHVLOEZJNnc/s0/RoadRash22.jpg' alt='Woman looking front' />
    </div>
    <div className="text-center mt-2">
        <h2 className="font-semibold">Bubu</h2>
        <p className="text-gray-500">is a gay</p>
    </div>
